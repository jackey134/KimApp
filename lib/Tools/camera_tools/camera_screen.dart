...
class _CameraScreenState extends State<CameraScreen>
  ...
  Future<void> getPublicDirectoryPath() async {
    ...
    path = "${await ExternalPath.getExternalStoragePublicDirectory(
        ExternalPath.DIRECTORY_DCIM)}/KimApp_pic";
                                        ...
                                        onTap: _isVideoCameraSelected
                                            ? () async {
                                                if (_isRecordingInProgress) {
                                                  ...
                                                  var Video_Path = "$_exPath/$currentUnix.$fileFormat";
                                                  print(Video_Path);


                                                  setState(() {
                                                    Video_Path = VideoPath; // /storage/emulated/0/Download
                                                  });
                                            ...
                                            : () async {
                                                ...
                                                var imagrPath = "$_exPath/$currentUnix.$fileFormat";
                                                print(imagrPath);
